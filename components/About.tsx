...
const About = (props: Props) => {
  return (
    <motion.div
      ...
      className="h-screen flex flex-col relative text-center lg:text-left lg:flex-row max-w-7xl px-5 justify-evenly mx-auto items-center"
    >
      ...
      <motion.img
        ...
        src={"/about.svg"}
        alt="Coding pic"
        className="-mb-40 md:mb-0 w-40 h-40 flex-shrink-0 rounded-full md:rounded-lg md:w-64 md:h-64 xl:w-96 xl:h-96"
      />
